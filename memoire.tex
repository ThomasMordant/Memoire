...
Soit $P$ un polynôme de degré $d$ dont les points critiques sont des croisements. Soit $Q$ un polynôme de degré $d$ dont la courbe algébrique ne passe pas par les points critiques de $P$.
 Soit $U$ un voisinage régulier de $\R A$ dans $\P^{2}(\R)$ tel que $U$ se décompose selon : \[U = U_0 \cup U_1 \]où $U_0$ est voisinage des points critiques et $U_1$ est un voisinage tubulaire de la sous-variété $\R P-U_0$ dans $\P^{2}(\R)-U_0$.
